...
package local_project.ese9_0_1;
 ...
 * @status
 */
public class Ese9 implements TalendJob {
	...
	private final String jobName = "Ese9";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Ese9.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Ese9 = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Ese9 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Ese9.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_Ese9.length == 0) {
						commonByteArray_LOCAL_PROJECT_Ese9 = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Ese9 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Ese9, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Ese9, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_Ese9, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Ese9, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Ese9) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:LJGD0Gd7rLtuDfcjBqZLJwQmumYebHoEnkQ7JQ==");
				...
				Object source_tFileInputExcel_1 = context.localPath + "FileInput/Employees.xlsx";
...
// Start of branch "row1"
							if (row1 != null) {
								...
								rowtFileOutputDelimited_1[0] = row1.emp_id == null ? null : row1.emp_id;
								rowtFileOutputDelimited_1[1] = row1.fname == null ? null : row1.fname;
								rowtFileOutputDelimited_1[2] = row1.minit == null ? null : String.valueOf(row1.minit);
								rowtFileOutputDelimited_1[3] = row1.lname == null ? null : row1.lname;
								rowtFileOutputDelimited_1[4] = row1.job_id == null ? null : String.valueOf(row1.job_id);
								rowtFileOutputDelimited_1[5] = row1.job_lvl == null ? null
										: String.valueOf(row1.job_lvl);
								rowtFileOutputDelimited_1[6] = row1.pub_id == null ? null : row1.pub_id;
								rowtFileOutputDelimited_1[7] = row1.hire_date == null ? null
										: FormatterUtils.format_Date(row1.hire_date, "yy-MM-dd");
	...
	public static void main(String[] args) {
		final Ese9 Ese9Class = new Ese9();

		int exitCode = Ese9Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Ese9.class.getClassLoader()
					.getResourceAsStream("local_project/ese9_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Ese9.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Ese9");
		}
...
/************************************************************************************************
 * 67915 characters generated by Talend Open Studio for Data Integration on the
 * February 8, 2026 at 6:01:21 PM CET
 ************************************************************************************************/
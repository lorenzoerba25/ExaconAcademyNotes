...
package local_project.ese3_0_1;
 ...
 * @status
 */
public class Ese3 implements TalendJob {
	...
	private final String jobName = "Ese3";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Ese3.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Ese3 = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Ese3 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Ese3.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_Ese3.length == 0) {
						commonByteArray_LOCAL_PROJECT_Ese3 = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Ese3 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Ese3, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Ese3, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_Ese3, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Ese3, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Ese3) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/outEmp.csv")).getAbsolutePath()
								.replace("\\", "/");
...
// Start of branch "row1"
						if (row1 != null) {
							...
							rowtFileOutputDelimited_1[5] = row1.job_lvl == null ? null : String.valueOf(row1.job_lvl);
	...
	public static void main(String[] args) {
		final Ese3 Ese3Class = new Ese3();

		int exitCode = Ese3Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Ese3.class.getClassLoader()
					.getResourceAsStream("local_project/ese3_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Ese3.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Ese3");
		}
...
/************************************************************************************************
 * 66241 characters generated by Talend Open Studio for Data Integration on the
 * February 8, 2026 at 9:51:02 AM CET
 ************************************************************************************************/